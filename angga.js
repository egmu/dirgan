...
let buttons = [
{buttonId: `owner`, buttonText: {displayText: '⋮☰ 𝗢𝗪𝗡𝗘𝗥'}, type: 1}, {buttonId: `donasi`, buttonText: {displayText: '⋮☰ 𝗗𝗢𝗡𝗔𝗦𝗜'}, type: 1}
]
let buttonMessage = {
...
mediaType:1,
mediaUrl: 'https://youtube.com/@DEVIL-X-CODE',
sourceUrl: "https://youtube.com/@DEVIL-X-CODE"
}}
}
...
┃⫹⫺ Saweria = [https://saweria.co/Rzl1023]
┗━━━━ꕥ
┏━━ꕥ〔 *NOTE* 〕ꕥ━⬣
...
⫹⫺ Url : ${anu.url}`,
		...
		let buttons = [{ buttonId: `gcsearch ${text}`, buttonText: { displayText: 'Next' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '⋮☰ 𝗗𝗢𝗡𝗔𝗦𝗜' }, type: 1 }]
...
case 'tiktoknowm':
			...
			case 'tt':
				...
				let nih = ` 𝘕𝘪𝘩 𝘒𝘢𝘬 𝘔𝘢𝘥𝘦 𝘉𝘺 ${author} 𝘑𝘢𝘯𝘨𝘢𝘯 𝘓𝘶𝘱𝘢 𝘚𝘶𝘴𝘤𝘳𝘪𝘣𝘦 https://www.youtube.com/@DEVIL-X-CODE`
				let buttons = [
...
┗─────────────────⬣`
      let ments = [ownernya, me, ini_mark]        
            let buttons = [{ buttonId: 'allmenu', buttonText: { displayText: '⋮☰ 𝗔𝗟𝗟 𝗠𝗘𝗡𝗨' }, type: 1 },{ buttonId: 'command', buttonText: { displayText: '⋮☰ 𝗟𝗜𝗦𝗧 𝗠𝗘𝗡𝗨' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: '⋮☰ 𝗥𝗨𝗟𝗘𝗦' }, type: 1 }]
            let buttonMessage = {
	...
	const sections = [{
							...
							},
							{
								...
								"rows": [
									{
										"title": "Thanks To ❤️",
										"description": "𝘑𝘢𝘯𝘨𝘢𝘯 𝘓𝘶𝘱𝘢 𝘚𝘶𝘴𝘤𝘳𝘪𝘣𝘦 𝘊𝘩𝘢𝘯𝘦𝘭 DEVIL-X-CODE",
										"rowId": `${prefix}tqto`
									}
								]
							}
...
const buttons = [
  {buttonId: 'rules', buttonText: {displayText: '⋮☰ 𝗥𝗨𝗟𝗘𝗦'}, type: 1},
